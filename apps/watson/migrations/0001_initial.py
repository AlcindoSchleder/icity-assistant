# Generated by Django 2.2.12 on 2020-04-04 06:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_watson_components', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='watson.WatsonComponents', verbose_name='Componente')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('component_id', models.CharField(blank=True, max_length=100, null=True, verbose_name='Id do Componente')),
                ('api_key', models.CharField(default='', max_length=180, verbose_name='API Key')),
                ('url', models.TextField(default='https://', verbose_name='URL')),
                ('insert_date', models.DateTimeField(auto_now_add=True, verbose_name='Data Inserção')),
                ('update_date', models.DateTimeField(auto_now=True, null=True, verbose_name='Data Edição')),
                ('fk_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Proprietário')),
                ('fk_watson_components', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='watson.WatsonComponents', verbose_name='Componente')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['fk_user', 'fk_watson_components'], name='watson_acce_fk_user_38c8d9_idx'),
        ),
    ]
